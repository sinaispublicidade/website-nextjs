  ...
  return (
    <>
      <Image
        ...
        priority
      />
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-8 sm:grid sm:grid-cols-5 md:px-12">
        <div className="w-full max-w-md font-sans sm:col-span-3 sm:max-w-lg sm:pb-8 lg:max-w-2xl">
          <h1 className="text-2xl font-bold sm:text-3xl lg:text-[40px]">
            Há mais de 15 anos gerando resultados reais
          </h1>

          <blockquote className="mt-4">
            <p className="mb-8 text-base italic md:text-lg lg:text-xl">
