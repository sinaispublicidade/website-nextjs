...
export const testimonials: ITestimonial[] = [
  ...
  /* {
    ...
    text: 'A SINAIS é uma parceira estratégica da BAUMINAS há muitos anos. Atende todo o nosso grupo com soluções completas de comunicação, sempre com visão de marca, consistência e profundidade estratégica. Ter um parceiro como a SINAIS, liderado pelo Knorral, é essencial para sustentar e evoluir nossas marcas.',
  },
  {
